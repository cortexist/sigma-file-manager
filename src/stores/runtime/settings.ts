...
export const useSettingsStore = defineStore('settings', () => {
  ...
  async function init() {
    ...
    const [
      ...
      { default: QuickViewPlaybackSection },
      { default: LanShareSection },
      ...
      import('@/modules/settings/ui/categories/general/quick-view-playback.vue'),
      import('@/modules/settings/ui/categories/general/lan-share.vue'),
    ...
    allSections.value = [
      ...
      {
        key: 'quickViewPlaybackOnDismiss',
        titleKey: 'settings.general.quickViewPlaybackOnDismiss.title',
        tags: 'settingsTags.navigator',
        component: markRaw(QuickViewPlaybackSection),
        category: 'general',
      },
      {
        key: 'lanShare',
        titleKey: 'settings.general.lanShare.title',
        tags: 'settingsTags.lanShare',
        component: markRaw(LanShareSection),
        category: 'general',
      },
      {
        key: 'dateTime',
